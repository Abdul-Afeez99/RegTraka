import { adminSidbarLinks } from "@/data";
		...
		>
			...
			<h1
				className={clsx(
					...
					!expanded &&
						"text-center rounded-md bg-white/20 w-12 h-12 p-0 flex justify-center items-center"
				)}
			>
				{expanded ? "Regtraka" : "R"}
			</h1>
			<div className="flex flex-col gap-4 flex-1">
				{adminSidbarLinks.map((link) => {
					return <NavLink {...{ ...link, expanded }} />;
				})}
			</div>
